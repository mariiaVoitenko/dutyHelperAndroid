...
public class DutyListAdapter  extends ArrayAdapter<Duty> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            startDate.setText(DataConverter.timeStampToString(
                    DataConverter.stringToTimeStamp(
                            itemsArrayList.get(position).getStartDate()
                    )
            ));
            endDate.setText(DataConverter.timeStampToString(
                    DataConverter.stringToTimeStamp(
                            itemsArrayList.get(position).getEndDate()
                    )
            ));
